...
exports.libclang = new FFI.Library('libclang', {
  ...
  clang_visitChildrenWithBlock: [ref.types.uint32, [
    CXCursor,
  ...
  clang_Cursor_getParsedComment: [CXComment, [
    CXCursor,
  ]],
  ...
  clang_Comment_getKind: [ref.types.uint32, [
    CXComment,
  ]],
  clang_Comment_getNumChildren: [ref.types.uint32, [
    CXComment,
  ]],
  clang_Comment_getChild: [CXComment, [
    CXComment,
    ref.types.uint32,
  ]],
  clang_Comment_isWhitespace: [ref.types.uint32, [
    CXComment,
  ]],
  clang_InlineContentComment_hasTrailingNewline: [ref.types.uint32, [
    CXComment,
  ]],
  clang_TextComment_getText: [CXString, [
    CXComment,
  ]],
  clang_InlineCommandComment_getCommandName: [CXString, [
    CXComment,
  ]],
  clang_InlineCommandComment_getRenderKind: [ref.types.uint32, [
    CXComment,
  ]],
  clang_InlineCommandComment_getNumArgs: [ref.types.uint32, [
    CXComment,
  ]],
  clang_InlineCommandComment_getArgText: [CXString, [
    CXComment,
    ref.types.uint32,
  ]],
  clang_HTMLTagComment_getTagName: [CXString, [
    CXComment,
  ]],
  clang_HTMLStartTagComment_isSelfClosing: [ref.types.uint32, [
    CXComment,
  ]],
  clang_HTMLStartTag_getNumAttrs: [ref.types.uint32, [
    CXComment,
  ]],
  clang_HTMLStartTag_getAttrName: [CXString, [
    CXComment,
    ref.types.uint32,
  ]],
  clang_HTMLStartTag_getAttrValue: [CXString, [
    CXComment,
    ref.types.uint32,
  ]],
  clang_BlockCommandComment_getCommandName: [CXString, [
    CXComment,
  ]],
  clang_BlockCommandComment_getNumArgs: [ref.types.uint32, [
    CXComment,
  ]],
  clang_BlockCommandComment_getArgText: [CXString, [
    CXComment,
    ref.types.uint32,
  ]],
  clang_BlockCommandComment_getParagraph: [CXComment, [
    CXComment,
  ]],
  clang_ParamCommandComment_getParamName: [CXString, [
    CXComment,
  ]],
  clang_ParamCommandComment_isParamIndexValid: [ref.types.uint32, [
    CXComment,
  ]],
  clang_ParamCommandComment_getParamIndex: [ref.types.uint32, [
    CXComment,
  ]],
  clang_ParamCommandComment_isDirectionExplicit: [ref.types.uint32, [
    CXComment,
  ]],
  clang_ParamCommandComment_getDirection: [ref.types.uint32, [
    CXComment,
  ]],
  clang_TParamCommandComment_getParamName: [CXString, [
    CXComment,
  ]],
  clang_TParamCommandComment_isParamPositionValid: [ref.types.uint32, [
    CXComment,
  ]],
  clang_TParamCommandComment_getDepth: [ref.types.uint32, [
    CXComment,
  ]],
  clang_TParamCommandComment_getIndex: [ref.types.uint32, [
    CXComment,
    ref.types.uint32,
  ]],
  clang_VerbatimBlockLineComment_getText: [CXString, [
    CXComment,
  ]],
  clang_VerbatimLineComment_getText: [CXString, [
    CXComment,
  ]],
  clang_HTMLTagComment_getAsString: [CXString, [
    CXComment,
  ]],
  clang_FullComment_getAsHTML: [CXString, [
    CXComment,
  ]],
  clang_FullComment_getAsXML: [CXString, [
    CXComment,
  ]],
  ...
  clang_findReferencesInFile: [ref.types.void, [
    CXCursor,
    CXFile,
